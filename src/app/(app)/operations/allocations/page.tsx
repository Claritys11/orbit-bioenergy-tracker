...
export default async function AllocationsPage() {
  await requireUser("calculate_allocation");
  ...
  return (
    <div className="grid gap-6">
      <PageHeader title="Energy Allocation" description="Finalised allocation versions calculated from verified allocatable gas. Corrections require a new version and audit entry." />
        ...
        <Card>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              <thead className="text-xs uppercase text-slate-500"><tr><th className="py-2">Cycle</th><th>Pool</th><th>Version</th><th>Status</th><th>Allocated</th><th>Fulfilled</th></tr></thead>
